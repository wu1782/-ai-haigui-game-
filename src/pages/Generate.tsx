        ...
        <main className="relative max-w-xl mx-auto px-6 py-8">
          ...
          <FadeIn delay={100}>
            <div className="bg-white/80 dark:bg-dark-800/80 backdrop-blur-xl rounded-3xl border border-gray-200/50 dark:border-dark-700/50 p-6 mb-6 shadow-lg">
              {/* 加载指示器 */}
              {isGenerating && (
                <div className="mb-4 p-4 bg-gradient-to-r from-game-500/10 to-purple-500/10 border border-game-500/20 rounded-2xl">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <div className="w-10 h-10 border-2 border-game-200 dark:border-game-800 rounded-full" />
                      <div className="absolute inset-0 w-10 h-10 border-2 border-transparent border-t-game-500 rounded-full animate-spin" />
                    </div>
                    <div className="flex-1">
                      <p className="text-game-600 dark:text-game-400 font-medium text-sm">AI 正在创作中...</p>
                      <p className="text-gray-500 dark:text-gray-400 text-xs">请稍候，正在生成独特的海龟汤故事</p>
                    </div>
                  </div>
                </div>
              )}
